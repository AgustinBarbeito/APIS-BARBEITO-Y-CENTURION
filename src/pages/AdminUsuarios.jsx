...
const AdminUsuarios = () => {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm('¿Estás seguro de que quieres eliminar este usuario? Esta acción eliminará definitivamente al usuario de la base de datos y no se puede deshacer.')) {
      return;
    }
        ...
        <div className="search-filters-section">
          ...
          <div className="filters-container">
            ...
            <div className="filter-stats">
              <span>📊 {filteredUsuarios.length} de {usuarios.length} usuarios</span>
            </div>
